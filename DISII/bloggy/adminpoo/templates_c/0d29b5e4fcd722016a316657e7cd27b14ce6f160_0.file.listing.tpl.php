...
function content_5e5524354301e8_57696763 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                    <?php if ($_smarty_tpl->tpl_vars['clef']->value == 'idCategories') {?>
                        <td><a href="./index.php?page=categorie&action=edit&id=<?php echo '<?=';?>
$valeur;<?php echo '?>';?>
">+</a>&nbsp;<a href="./index.php?page=categorie&action=delete&id=<?php echo '<?=';?>
$valeur;<?php echo '?>';?>
">-</a></td>
                    <?php } else { ?>
