				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-12 banner-content">
							<h6 class="text-white">L'amour gustatif</h6>
							<h1 class="text-white">Bloggy</h1>
							<p class="text-white">
								Tout pour bien manger.
                                                        </p>
							<a href="blog-home.php" class="primary-btn text-uppercase">consulter notre blog</a>
						</div>
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="active-review-carusel">
							<div class="single-review">
								...
								<p>
									â€œAccessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker. Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker.â€?
								</p>
							</div>
							<div class="single-review">
								<img src="img/user.png" alt="">
